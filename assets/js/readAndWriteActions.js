...
[
			...
			[
				...
				"near Batna City",
				"Medracen",
				"Monumental Tomb (circular shape)",
				"",
				"1 level, Peristyle around the tomb on the outside",
				"III<sup>rd</sup> c. B.C.",
				"PUNIC <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Tanit_Symbol.svg/800px-Tanit_Symbol.svg.png' style='max-width:100px;'>",
				"<a href='https://upload.wikimedia.org/wikipedia/commons/c/c7/Mausol%C3%A9e_des_Rois_numides_dit_le_Medracen_-2.JPG'><img src='https://upload.wikimedia.org/wikipedia/commons/c/c7/Mausol%C3%A9e_des_Rois_numides_dit_le_Medracen_-2.JPG' style='max-width:100px;'></a>",
				"No Image"
			],
			[
				"1",
				"Algeria",
				"Siga / Siphax / Béni Rhénane",
				"",
				"",
				"Monumental Tomb (rectangular tower shape)",
				"",
				"3 levels, Four sides decorated",
				"end II<sup>nd</sup> c. B.C. (https://journals.openedition.org/encyclopedieberbere/1684)",
				"PUNIC <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Tanit_Symbol.svg/800px-Tanit_Symbol.svg.png' style='max-width:100px;'>",
				"<a href='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSl-UrZSyX-soOxg9V6xyXwBAzYgzM4FBAiUA2MmSmY5zV2kIdVA97YWjxQ_jBqgNI0gvg&usqp=CAU'><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSl-UrZSyX-soOxg9V6xyXwBAzYgzM4FBAiUA2MmSmY5zV2kIdVA97YWjxQ_jBqgNI0gvg&usqp=CAU' style='max-width:100px;'></a>",
				"<a href='https://journals.openedition.org/encyclopedieberbere/docannexe/image/1684/img-3-small480.png'><img src='https://journals.openedition.org/encyclopedieberbere/docannexe/image/1684/img-3-small480.png' style='max-width:100px;'></a>",
			]
];
...
var fixtureCSV = `Region / Country;Archaeological Site;Area;Nickname;Plan;Facade;Additional Info.;Datation\rAlgeria;Numidia;near Batna city;Medracen;Monumental Tomb (circular shape);;1 level, Peristyle around the tombon the outside;III<sup>rd</sup> c. B.C.\rAlgeria;Siga / Siphax / Béni Rhénane;;;Monumental Tomb (rectangular tower shape);;3 levels, Four sides decorated;end II<sup>rd</sup> c. B.C.`;
...
function loadCsvContentIntoPage()
{
	...
	importArrayIntoTable(csvValues, 'tableMonumentalBuildings');
...
// ---------------- SAVE FILE BUTTON ACTIONS --------------
	...
	const get = async function () {
			table = document.getElementById("tableMonumentalBuildings");
			trHeadersStr = document.getElementById("tableMonumentalBuildings").getElementsByTagName("thead")[0].outerHTML;
...
function htmlContentForExport() {
	...
	'<script>' +
	`
		var map = L.map('map').setView([38.871815, 14.543821], 5);
